  ...
  return (
    <footer className="bg-[#010719] text-[#F4F0E6] pt-16 pb-10 border-t border-[rgba(214,166,58,0.20)]">
      <div className="max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-3 flex flex-col gap-6">
          ...
          <ul className="flex flex-col gap-3 text-xs tracking-wider uppercase font-medium text-[#AAB3C3]">
            <li>
              <a href="https://businessandbeyondindia.com/terms-condition" target="_blank" rel="noopener noreferrer" className="hover:text-[#D6A63A] transition-colors">
                Terms and Conditions
              </a>
            </li>
            <li>
              <a href="https://businessandbeyondindia.com/privacy-policies" target="_blank" rel="noopener noreferrer" className="hover:text-[#D6A63A] transition-colors">
                Privacy Policies
              </a>
            </li>
            <li>
              <a href="https://businessandbeyondindia.com/refund-policies" target="_blank" rel="noopener noreferrer" className="hover:text-[#D6A63A] transition-colors">
                Refund Policies
              </a>
            </li>
          </ul>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 mt-16 pt-8 border-t border-[rgba(255,255,255,0.06)] text-center text-xs text-[#AAB3C3]/70 font-light">
        <p>Copyright © 2026 Business &amp; Beyond. All rights reserved.</p>
